<%-- 
    Document   : tkphutung
    Created on : Nov 11, 2022, 8:24:41 AM
        ...
        =====================================
            ...
            <div class="page-wrapper">
                ...
                <div class="content-wrapper">
                    <br>
                    <h1 style="color: black; text-align: center">Thống kê phụ tùng</h1>
                    <br>
                    <div class="form-row">
         <span>
                            <input type="date" id="appt" name="appt"
                                   value="2021-11-29"
                                   min="2021-10-24" max="2022-11-29" style="margin-left: 250px">   <i>ngày bắt đầu</i></span>

                        <span>
                            <input type="date" id="start" name="trip-start"
                                   value="2021-11-29"
                                   min="2021-10-24" max="2022-11-29" style="margin-left: 400px">   <i>ngày kết thúc</i></span>
                        ...
                        <table id="example" class="table table-bordered table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>100</td>
                                    <td>
                                        <a href="phutungchitiet.html" class="btn btn-primary">Xem</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
