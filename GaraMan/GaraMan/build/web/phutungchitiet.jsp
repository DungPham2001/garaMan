        ...
        =====================================
            ...
            <div class="page-wrapper">
                ...
                <div class="content-wrapper">
                    <br>
                    <h1 style="color: black; text-align: center">Phụ tùng</h1>
                    <br>
                    ...
                    <div class="container mt-3">
                        <table id="example" class="table table-bordered table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td>10</td>
                                <td>
                                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myDV" onclick="showInfo('1','Bảo dưỡng','500$','Bảo dưỡng xe ô tô giúp kiểm tra và phát hiện những rủi ro tiềm tàng để ngăn ngừa nó một cách hiệu quả.','10')">Xem</a>
                                </td>
                            </tbody>
                        </table>
                    </div>
